import random
movies = ["deadpool","avengers","ironman","thor","hulk","spiderman","blackpanther","captain america","antman","doctor strange","guardians of the galaxy","x men","fantastic"]
...
def play():
    ...
    while willing:
        if turn%2==0:
            print(f"{p1name} it's your turn")   #player 1 turn
